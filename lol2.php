...
<a href = 'lol2.php?email=<?php echo"$var"; ?>&name=<?php echo"$name";?>'><img src="data:image/jpeg;base64,<?php echo base64_encode( $r); ?>" width="150" style="height:auto;-webkit-border-radius: 5px;-moz-border-radius: 5px;border-radius: 5px;" border="0" /><br clear="all" /></a> </span><span  style="font-family: inherit; ">
<?php 
echo "<br>";
echo "<b>Name: : </b>";
echo "".$name."<br>";
